...
app.controller('RnD/CustomerClassUpdateController', function ($scope, appFactory ) {
    window.scope = $scope;
    Spinner($scope, 'off');
    ...
    $scope.submit = function ()
    {
        try
        {
            ...
            else
            {
                ...
                {   
                    ...
                    xhr.open('POST', '/Rnd/CustomerClassUpdateRun');
                    xhr.send(formdata);
        ...
        {
            ErrorMsg(e, 'File = CustomerClassUpdate.js | Function = submit()');
        }
    };
