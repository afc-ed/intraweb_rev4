...
app.controller('Connect/AnnouncementNew', function ($scope, appFactory, $modalInstance, $modal)
{
    window.scope = $scope;    
    ...
    $scope.save = function ()
    {
        ...
        {
            Spinner($scope, 'on'); 
            appFactory.postRequest('/Connect/AnnouncementCreate', $scope.input)
                .then(function (response)
                {
                    if (!appFactory.errorCheck(response))
                    {
                        ...
                        {
                            alert("Error. Cannot create Announcement.");
                        }
                    }
                })
