...
app.controller('Connect/FormNew', function ($scope, appFactory, $modalInstance, $modal)
{
    window.scope = $scope;    
    ...
    $scope.save = function ()
    {
        ...
        {
            Spinner($scope, 'on'); 
            appFactory.postRequest('/Connect/FormCreate', $scope.input)
                .then(function (response)
                {
                    if (!appFactory.errorCheck(response))
                    {
                        ...
                        {
                            alert("Error. Cannot create Form.");
                        }
                    }
                })
